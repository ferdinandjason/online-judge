<div class="ui vertical menu">
    <a class="{{(Request::is('contest/*') && !Request::is('contest/*/problems') && !Request::is('contest/*/submission') && !Request::is('contest/*/scoreboard'))?'active ':''}}blue item" href="/contest/{{$contest->id}}">
        Home
        @if(Request::is('contest/*') && !Request::is('contest/*/problems') && !Request::is('contest/*/submission') && !Request::is('contest/*/scoreboard'))
