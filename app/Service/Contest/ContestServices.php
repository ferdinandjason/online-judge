...
class ContestServices
{
    ...
    public function prosesPostData($post_data)
    {
        ...
        $post_data['start_time'] = Carbon::parse($post_data['start_time']);
        $post_data['freeze_time'] = Carbon::parse($post_data['freeze_time']);
        $post_data['end_time'] = Carbon::parse($post_data['end_time']);
